  ...
  },
  {
    ...
    rules: {
      always: [
        ...
        'During a vocabulary quiz, call log_quiz_result after each student answer with the word, correctness, and category. At the end, summarize the results and call end_exercise to restore normal speech detection.',
