...
export const pt: Translations = {
  ...
  // Teacher Page
  teacherTitle: 'Professor de Inglês',
  teacherSubtitle: 'Pratique inglês com Sofia, sua tutora de IA',
  teacherStartLesson: 'Iniciar Aula',
  teacherEndLesson: 'Encerrar Aula',
  teacherVoiceModel: 'Voz',
  teacherLevel: 'Nível',
  teacherStreak: 'Sequência',
  teacherPoints: 'XP',
  teacherDays: 'dias',
  teacherQuickActions: 'Ações Rápidas',
  teacherVocabQuiz: 'Quiz Vocabulário',
  teacherGrammarQuiz: 'Quiz Gramática',
  teacherRoleplay: 'Roleplay',
  teacherDictation: 'Ditado',
  teacherFlashcards: 'Flashcards',
  teacherDebate: 'Debate',
  teacherPronunciation: 'Pronúncia',
  teacherImmersion: 'Imersão',
  teacherProgress: 'Progresso',
  teacherTodayExpression: 'Expressão do Dia',
  teacherNoLevel: 'Novo Aluno',
  teacherWelcomeTitle: 'Bem-vindo ao Professor de Inglês!',
  teacherWelcomeStep1Title: 'Converse com Sofia',
  teacherWelcomeStep1Desc: 'Tenha conversas por voz naturais com sua tutora de IA. Ela se adapta ao seu nível.',
  teacherWelcomeStep2Title: 'Pratique Atividades',
  teacherWelcomeStep2Desc: 'Use ações rápidas para quizzes, roleplay, ditado e mais.',
  teacherWelcomeStep3Title: 'Acompanhe o Progresso',
  teacherWelcomeStep3Desc: 'Seu nível, vocabulário e sequências são rastreados automaticamente.',
  teacherWelcomeStart: 'Começar',
  teacherEmptyState: 'Inicie uma aula para começar a praticar inglês com Sofia...',
  teacherChallengeActive: 'Desafio Ativo',
  teacherCorrections: 'Correções',
  teacherWordsLearned: 'Palavras',
  teacherSessionTime: 'Tempo',
  teacherApiKeyNeeded: 'Adicione sua chave API da OpenAI nas Configurações para começar',
  teacherGoToSettings: 'Ir para Configurações',
};
