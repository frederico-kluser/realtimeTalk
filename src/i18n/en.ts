export const en = {
  ...
  teacherSubtitle: 'Practice English with Sofia, your AI tutor',
  teacherStartLesson: 'Start Lesson',
  teacherEndLesson: 'End Lesson',
  teacherVoiceModel: 'Voice',
  teacherLevel: 'Level',
  teacherStreak: 'Streak',
  teacherPoints: 'XP',
  teacherDays: 'days',
  teacherQuickActions: 'Quick Actions',
  teacherVocabQuiz: 'Vocab Quiz',
  teacherGrammarQuiz: 'Grammar Quiz',
  teacherRoleplay: 'Roleplay',
  teacherDictation: 'Dictation',
  teacherFlashcards: 'Flashcards',
  teacherDebate: 'Debate',
  teacherPronunciation: 'Pronunciation',
  teacherImmersion: 'Immersion',
  teacherProgress: 'Progress',
  teacherTodayExpression: "Today's Expression",
  teacherNoLevel: 'New Student',
  teacherWelcomeTitle: 'Welcome to English Tutor!',
  teacherWelcomeStep1Title: 'Talk with Sofia',
  teacherWelcomeStep1Desc: 'Have natural voice conversations with your AI tutor. She adapts to your level.',
  teacherWelcomeStep2Title: 'Practice Activities',
  teacherWelcomeStep2Desc: 'Use quick actions for quizzes, roleplay, dictation, and more.',
  teacherWelcomeStep3Title: 'Track Progress',
  teacherWelcomeStep3Desc: 'Your level, vocabulary, and streaks are tracked automatically.',
  teacherWelcomeStart: 'Get Started',
  teacherEmptyState: 'Start a lesson to begin practicing English with Sofia...',
  teacherChallengeActive: 'Challenge Active',
  teacherCorrections: 'Corrections',
  teacherWordsLearned: 'Words',
  teacherSessionTime: 'Time',
  teacherApiKeyNeeded: 'Add your OpenAI API key in Settings to start',
  teacherGoToSettings: 'Go to Settings',
};
